...
class CreateCoursePage(BasePage):
    ...
    def check_visible_create_exercise_form(self, index: int, text: str, description: str):
        ...
        exercise_title_input = self.page.get_by_test_id(
            f"create-course-exercise-form-title-{index}-input").locator(
            "input"
        )
        ...
        expect(exercise_title_input).to_have_value(text)
    ...
    def fill_create_exercise_form(self, index: int, text:str, description: str):
        ...
        exercise_title_input.fill(text)
        expect(exercise_description_input).to_have_value(text)
